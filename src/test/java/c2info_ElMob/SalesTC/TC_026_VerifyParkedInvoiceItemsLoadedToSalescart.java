...
public class TC_026_VerifyParkedInvoiceItemsLoadedToSalescart extends TestBase{
	...
	public void verifyInvoiceLoading() throws InterruptedException{
		...
		Thread.sleep(2000);
		ArrayList<String> itemNames = salesCart.getItemNamesFromcartPage();
		System.out.println(itemNames);
		
		assertTrue(itemNames.contains("Ecolite Tax0")==true);
		assertTrue(itemNames.contains("Ecolite Tax12")==true);
	}
